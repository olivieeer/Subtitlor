...
public class ModifSubtitle extends HttpServlet {
    ...
    private static final String         VIEW1                   = "/WEB-INF/editSubtitleDouble.jsp";
    ...
    protected void doGet( HttpServletRequest request, HttpServletResponse response )
        ...
        if ( this.subtitlesHandler == null ) {
            ...
            ArrayList<CoupleOfCustomizedString> doubleSubtitlesDb = this.subtitlesHandler
                    .getListCoupleOfCustomizedString( listCustomizedString );
            request.getSession().setAttribute( "doubleSubtitles", doubleSubtitlesDb );
            this.getServletContext().getRequestDispatcher( VIEW1 ).forward( request,
                    response );
        }
    }
