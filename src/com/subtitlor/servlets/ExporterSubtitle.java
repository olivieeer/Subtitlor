...
public class ExporterSubtitle extends HttpServlet {
    ...
    private static final String VIEW             = "/WEB-INF/exporterFileSrt.jsp";
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        if ( this.subtitlesHandler == null ) {
            request.setAttribute( "erreurPasDeFichierUploade",
                    new String( "Aucun fichier ne sont disponible à l'export" ) );
            this.getServletContext().getRequestDispatcher( "/index.jsp" ).forward( request, response );
        } else {
            String rootPath;
